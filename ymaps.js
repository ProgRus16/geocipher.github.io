(function ymapsInit(e) {
	...
	t.modules = new o({
			...
			fetchBundle: function(e) {
				...
				o.src = t.env.hosts["static"] + t.env.bundles[e], o.setAttribute("data-ymaps-api-ns", r), o.setAttribute("data-ymaps-api-version", "2.1.79-11532562"), o.async = !0;
				var i = t.vow.defer();
		...
		}), t.modules.allowRemoteLoading(), r && (r.parent[r.name] = t.ns), t.env.apikeyValid || console.warn("(Yandex Maps JS API): Invalid API key")
})({
	"mode": "release",
	"debug": false,
	"namespace": "ymaps",
	...
	"enterprise": false,
	"bundles": {
		"full": "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-11532562/build/release/full-2e211ea3bc39b6696fa8e65a7c24d6a38733cebe.js"
	},
	"version": "2.1.79",
	"tag": "2.1.79-11532562",
	...
	"server": {
		...
		"path": "build/release",
		"params": {
			"amp;apikey": "047fb8bb-dfd1-4343-a8e9-db75bfd09a06",
			"csp": null
		},
		"version": "2.1"
	},
	...
	"token": "ed05e96afa6a3ba1e1a82f6a9504e58a",
	"taxiInceptionBboxes": [
		[
	...
	"layers": {
		"map": {
			"version": "23.06.18-0-b230526125330",
			"scaled": true,
		...
		"stv": {
			"version": "2023.06.19.01.54-1_23.06.16-3-15067"
		},
		"trf": {
			"version": "1687159560",
			"scaled": true
